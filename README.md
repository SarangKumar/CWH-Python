...
|<input type='checkbox' checked /> [Day 6](./Day%206/notes.md) |<input type='checkbox' checked/> [Day 16](/Day%2016/notes.md) |<input type='checkbox' checked/> [Day 26](/Day%2026/) |<input type='checkbox'/> Day 36 |<input type='checkbox'/> Day 46|<input type='checkbox'/> Day 56 |<input type='checkbox'/> Day 66 |<input type='checkbox'/> Day 76 |<input type='checkbox'/> Day 86 |<input type='checkbox'/> Day 96 |
